...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('learningZone_app', '0010_comment_parent'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('post', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='+', to='learningZone_app.comment')),
